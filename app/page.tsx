  ...
  return (
    <main style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 32px 80px' }}>
      ...
      <div style={{
        ...
        borderBottom: '1.5px solid var(--text)', paddingBottom: '18px',
      ...
      <div style={{ display: 'flex', borderBottom: '0.5px solid var(--border)', marginBottom: '24px' }}>
        {filters.map(f => (
          <button key={f.key} onClick={() => setActive(f.key)} style={{
            ...
            color: active === f.key ? 'var(--text)' : 'var(--gray)',
            borderBottom: active === f.key ? '1.5px solid var(--text)' : '1.5px solid transparent',
